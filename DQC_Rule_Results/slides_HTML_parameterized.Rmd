...
```{r eval = FALSE}
  params = list(
    ...
    dbname = "debug3_db",
    data_source = "database",
    file_input = "~/Google_Drive/Projects/DQC_slides/data/data_raw_14_17.csv",
    data_source_counts = "query",
    counts_file_input =
      "~/Google_Drive/Projects/DQC_slides/data/gaap_v_ext_unique_dp.csv",
...
if (params$data_source=="file"){
  ...
  rulesdata <- read_csv(params$file_input)
    ...
    command <- paste("bash", file.path(top_dir, "src/query_errors.sh"))
...
## Slide 1
# all, all, per1k, stack
png(file.path(top_dir, "plots/rule_violations_all_all_per1k_stack.png"), width = 800, height = 300)
...
png(file.path(top_dir, "plots/rule_violations_all_no15_no01_per1k_stack.png"), width = 800, height = 300)
...
## Slide 2
# laf, all, per1k, stack
png(file.path(top_dir, "plots/rule_violations_laf_all_per1k_stack.png"), width = 800, height = 300)
...
# Slide 3
# src, all, per1k, stack
png(file.path(top_dir, "plots/rule_violations_src_all_per1k_stack.png"), width = 800, height = 300)
...
png(file.path(top_dir, "plots/rule_violations_laf_no15_no01_per1k_stack.png"), width = 800, height = 300)
...
png(file.path(top_dir, "plots/rule_violations_src_no15_no01_per1k_stack.png"), width = 800, height = 300)
